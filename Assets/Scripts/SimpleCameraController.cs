...
namespace UnityTemplateProjects
{
    public class SimpleCameraController : MonoBehaviour
    {
        ...
        Vector3 GetInputTranslationDirection()
        {
            ...
            if (Input.GetKey(KeyCode.W) || (Input.GetAxis("Mouse Y")<0 && Input.GetMouseButton(0)))
            {
                direction += Vector3.up;
            }
            if (Input.GetKey(KeyCode.S) || (Input.GetAxis("Mouse Y") > 0 && Input.GetMouseButton(0)))
            {
                direction += Vector3.down;
            }
            if (Input.GetKey(KeyCode.A) || (Input.GetAxis("Mouse X") > 0 && Input.GetMouseButton(0)))
            {
                direction += Vector3.left;
            }
            if (Input.GetKey(KeyCode.D) || (Input.GetAxis("Mouse X") < 0 && Input.GetMouseButton(0)))
            {
        ...
        void Zoom(float dir1D)
        {
            float translation = (dir1D<0?1:-1) * Time.deltaTime * 0.1f;
            ...
            float size = m_Camera.orthographicSize + translation;
            size = size < 1 ? 1 : size;
        ...
        bool IsCameraRotationAllowed()
        {
            ...
            return canRotate && rotationEnabled;
#else
            return Input.GetMouseButton(1) && rotationEnabled;
#endif
        }
